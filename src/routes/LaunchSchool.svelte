...
<div id="ls-section" class="relative mx-auto max-w-7xl py-16 px-4 sm:py-20 sm:px-6 lg:px-8 lg:py-28">
	...
	<div class="hidden md:block absolute inset-0 overflow-hidden pointer-events-none">
		<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-heading/10 rounded-full blur-[120px]"></div>
	</div>
	...
	<div class="relative">
		...
		<div class="flex justify-center mb-8">
			<div class="relative group">
				<div class="absolute -inset-4 bg-gradient-to-r from-heading/20 via-heading-accent/10 to-heading/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
		...
		<div class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
			{#each stats as stat, i}
				<div class="stat-card opacity-0 group relative">
					<div class="absolute -inset-0.5 bg-gradient-to-b from-heading/50 to-heading-accent/40 rounded-2xl blur opacity-30 group-hover:opacity-60 transition-opacity duration-300"></div>
					<div class="relative flex flex-col items-center p-8 rounded-2xl bg-surface-muted/90 backdrop-blur-sm border border-heading/20 hover:border-heading/40 transition-all duration-300">
		...
		>
			...
			<div class="absolute -inset-1 bg-gradient-to-r from-heading/30 via-heading-accent/20 to-heading/30 rounded-2xl blur-lg opacity-50 group-hover:opacity-80 transition-opacity duration-500"></div>

			<div class="relative rounded-2xl bg-launchschool-notes p-8 lg:p-10 border-2 border-transparent hover:border-heading/60 transition-all duration-300 shadow-2xl">
				<h2 class="text-2xl lg:text-3xl font-bold tracking-tight text-txt space-grotesk flex items-center gap-3">
					<span class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-heading/10">
